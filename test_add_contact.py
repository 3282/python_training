...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.open_contact_name(wd)
        self.fill_new_contact_form(wd, Contact(firstname="Maria", middlename="Olegovna", lastname="Bakholdina", nickname="Masha", company="YOTA", address="Yakhtennaya 6", home="6789688",
